...
class StiffenedPlateAnalysisService():
    ...
    def create(self,
        ...
        try:
            ...
            self.strategy.define_geometry(mapdl, a, b, N_ts, N_ls, h_s)
            self.strategy.define_discretization(mapdl, a, b, t_1, N_ts, N_ls, h_s, mesh_size, stiffened_plate_analysis)
