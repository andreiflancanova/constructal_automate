...
class LongitudinallyStiffenedPlateStrategy(PlateStrategy):
    ...
    def define_geometry(self, mapdl, a, b, t_1, N_ts, N_ls, h_s):
        ...
        mapdl.k(1, 0, b_ls, 0)
        mapdl.k(2, a, b_ls, 0)
        mapdl.k(3, a, b_ls, h_s)
        mapdl.k(4, 0, b_ls, h_s)
        ...
        #### Geração dos NLS enrijecedores longitudinais
        mapdl.agen(itime=N_ls, na1=ENRIJECEDOR_LONGITUDINAL_PRE_APTN, dy=b_ls)

        #### Criação do componente dos enrijecedores longitudinais
        mapdl.allsel(labt="ALL", entity="ALL")
