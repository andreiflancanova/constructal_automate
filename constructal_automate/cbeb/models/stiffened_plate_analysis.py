...
from .buckling_type import BucklingType
...
class StiffenedPlateAnalysis(models.Model):
    ...
    # buckling_type = models.ForeignKey(BucklingType, on_delete=models.CASCADE)
    ...
    # elastoplastic_buckling_status =  models.ForeignKey(ProcessingStatus, on_delete=models.CASCADE, null=True, blank=True, related_name='elastoplastic_buckling_stiffenedplateanalysis_set')
    # TODO: Fazer a migration só de BucklingType, depois só de ProcessingStatus e só depois dessa aqui