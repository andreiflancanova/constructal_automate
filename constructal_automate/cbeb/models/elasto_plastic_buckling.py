...
class ElastoPlasticBuckling(models.Model):
    ...
    p_u_ts = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    p_u_ls = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    n_u = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    # sigma_u_ts = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    # sigma_u_ls = models.DecimalField(max_digits=8, decimal_places=2, null=True)
